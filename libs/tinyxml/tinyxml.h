...
typedef void *(*TiFileOpenFunc)( const char *pFilePath );
typedef int (*TiFileReadFunc)( void *pContext, void *pBuffer, int readSizeBytes );
typedef int (*TiFileSizeFunc)( void *pContext );
typedef void (*TiFileCloseFunc)( void *pContext );
